        ...
        <div className=" flex items-center gap-5 rounded-[30px] rounded-br-[290px] justify-between w-auto h-130 p-10 bg-linear-160 from-blue-600 to-pink-400 text-white">
          <div className="flex flex-col gap-5 p-5"> 
            ...
            <div className=" flex gap-3">
              <button className="border border-pink-400 text-white bg-pink-400 font-semibold px-5 py-1.5 rounded-md cursor-pointer">
                Get Started
              </button>
              <button className="border border-[#1E1E56] text-white font-semibold px-5 py-1.5 rounded-md hover:bg-[#1E1E56] hover:text-white transition-all cursor-pointer">
                Discount
              </button>
            </div>
          </div>
        ...
        <div className="flex flex-col items-center p-10 w-auto gap-10">
            <div className="flex items-center gap-30">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <div>
                        <button className="border border-pink-400 text-white bg-pink-400 font-semibold px-5 py-1.5 rounded-md cursor-pointer">Get Started</button>
                    </div>
